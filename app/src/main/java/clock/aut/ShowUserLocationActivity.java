...
public class ShowUserLocationActivity extends AppCompatActivity implements PermissionsListener {
...
// Add map fragment to parent container
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                ShowUserLocationActivity.this.mapboxMap = mapboxMap;
...
// parameter
    ...
    public void onPermissionResult(boolean granted) {
        if (granted) {
            ...
            Toast.makeText(this, "دسترسی های لازم برای لود نقشه داده نشده است", Toast.LENGTH_LONG).show();
            finish();
        }
    }
}
